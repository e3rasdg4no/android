...
public class User {
    ...
    public String getTanggal_ktp() {
        return tanggal_ktp;
    }

    public void setTanggal_ktp(String tanggal_ktp) {
        this.tanggal_ktp = tanggal_ktp;
    }
}
