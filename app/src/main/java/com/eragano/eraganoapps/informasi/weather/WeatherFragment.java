...
public class WeatherFragment extends Fragment {
    ...
    private void renderWeather(JSONObject json){
    	try {
	    	...
	    	detailsField.setText(
	    			...
	    			"\n" + "Kelembaban : " + main.getString("humidity") + "%" +
	    			"\n" + "Tekanan Udara : " + main.getString("pressure") + " hPa");
	    	
	    	currentTemperatureField.setText(
	    				String.format("Suhu Udara  : "+"%.2f", main.getDouble("temp"))+ " ℃");

	    	DateFormat df = DateFormat.getDateTimeInstance();
	    	String updatedOn = df.format(new Date(json.getLong("dt")*1000));
	    	updatedField.setText("Terakhir pemutakhiran: " + updatedOn);
	...
	private void showInputDialog(){
		...
		final CuacaActivity cu = new CuacaActivity();
		builder.setPositiveButton("Go", new DialogInterface.OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				cu.changeCity(input.getText().toString());
			}
		});
		builder.show();
	}
