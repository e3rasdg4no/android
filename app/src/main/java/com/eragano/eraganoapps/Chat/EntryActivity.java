package com.eragano.eraganoapps.Chat;
...
public class EntryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ZopimChat.init("3pMVzYzStjdtFgAq8DjjkIbIYczmznHh").build();
        ZopimChat.init("3pMVzYzStjdtFgAq8DjjkIbIYczmznHh").emailTranscript(EmailTranscript.DISABLED).build();
        Intent i = new Intent(EntryActivity.this,ZopimChatActivity.class);
        startActivity(i);
        finish();
    }
